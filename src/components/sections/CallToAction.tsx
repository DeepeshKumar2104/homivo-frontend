        ...
        <div className="md:flex md:items-center md:justify-between">
          <div className="md:max-w-2xl">
            ...
            <div className="mt-6 flex space-x-4">
              <Link
  to="/NotFound"
  className="inline-flex items-center justify-center px-6 py-3 border border-transparent rounded-md shadow-sm text-base font-medium text-indigo-700 bg-white hover:bg-gray-50 transition-colors"
>
  List Your Property
</Link>
