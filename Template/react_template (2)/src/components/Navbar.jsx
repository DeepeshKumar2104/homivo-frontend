            ...
            <div className="flex flex-col space-y-4 px-4">
              ...
              <div className="flex flex-col space-y-2 pt-2 border-t border-gray-200">
                <Link to="/login" onClick={() => setIsMenuOpen(false)}>
                  <button className="w-full bg-indigo-600 text-white px-5 py-2 rounded-lg font-medium transition-colors hover:bg-indigo-700">
                    Login
                  </button>
                </Link>
                <Link to="/signup" onClick={() => setIsMenuOpen(false)}>
                  <button className="w-full bg-white text-indigo-600 border border-indigo-600 px-5 py-2 rounded-lg font-medium transition-colors hover:bg-gray-100">
                    Sign Up
                  </button>
                </Link>
              </div>
