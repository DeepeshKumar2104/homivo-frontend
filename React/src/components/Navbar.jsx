        ...
        <div className="flex justify-between items-center">
          <div className="flex items-center">
            <div className="text-3xl font-bold">
              <a href="#" className={`${scrolled ? 'text-indigo-600' : 'text-white'} flex items-center`}>
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <div className="flex items-center space-x-4">
              <button className={`${scrolled ? 'bg-indigo-600 text-white' : 'bg-white text-indigo-600'} px-5 py-2 rounded-lg font-medium transition-colors hover:bg-indigo-700 hover:text-white focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-opacity-50`}>
                Login
              </button>
              <button className={`${scrolled ? 'bg-white text-indigo-600 border border-indigo-600' : 'bg-indigo-600 text-white'} px-5 py-2 rounded-lg font-medium transition-colors hover:bg-indigo-700 hover:text-white focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-opacity-50`}>
                Sign Up
              </button>
            </div>
          </div>
          ...
          <div className="md:hidden mt-4 py-4 bg-white rounded-lg shadow-lg">
            <div className="flex flex-col space-y-4 px-4">
              ...
              <div className="flex flex-col space-y-2 pt-2 border-t border-gray-200">
                <button className="bg-indigo-600 text-white px-5 py-2 rounded-lg font-medium transition-colors hover:bg-indigo-700">
                  Login
                </button>
                <button className="bg-white text-indigo-600 border border-indigo-600 px-5 py-2 rounded-lg font-medium transition-colors hover:bg-gray-100">
                  Sign Up
                </button>
              </div>
            </div>
